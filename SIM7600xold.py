...
class SIM7600x(threading.Thread):
    ...
    According to PI you are using, the user UART device of Raspberry Pi 2B/Zero is ttyAMA0, and ttyS0 of Raspberry Pi 3B.
    """
    def __init__(self, parent=None, port: str = "/dev/ttyS0", debug: bool = False, **kwargs):
